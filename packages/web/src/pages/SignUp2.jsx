      ...
      {/* main container */}
        ...
        <div className='grid grid-rows-6 grid-flow-col gap-4 justify-items-center mt-10'>
          ...
          <div className='w-full max-w-xs'>
            <label class="form-control">
            <div class="label">
                <span class="label-text flex flex-row font-bold">Country&nbsp;<h1 className='text-error'>*</h1></span>
              </div>
          ...
          <label class="form-control">
              <div class="label">
                <span class="label-text flex flex-row font-bold">Postal Code&nbsp;<h1 className='text-error'>*</h1></span>
              </div>
          ...
          <div className='w-full max-w-xs'>
            <label class="form-control">
            <div class="label">
                <span class="label-text flex flex-row font-bold">City&nbsp;<h1 className='text-error'>*</h1></span>
              </div>
              <form className='border rounded-lg border-[#7C7C7C] text-start py-3 flex items-center justify-center'>
                <select className='w-[90%] hover:border-white focus:border-white active:border-white ' id="name_title" name="name_title">

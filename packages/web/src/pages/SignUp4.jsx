            ...
            <div className="grid grid-rows-6 grid-flow-col justify-center">
                ...
                <div className='w-full col-span-3 mt-10'>
                    <div className="label grid grid-cols-5 gap-52 justify-items-start">
                        <span class="label-text flex flex-row font-bold text-lg text-start col-span-3">
                ...
                <div className='w-full col-span-3'>
                    <form action="">
                        <div className="label grid grid-cols-5 gap-52 justify-items-start">
                            <span class="label-text flex flex-row font-bold text-start col-span-3">
                            เป็นบริษัทหรือห้างหุ้นส่วนนิติบุคคลที่มีทุนจดทะเบียนชำระแล้ว
                            <br></br>ในวันสุดท้ายของ รอบระยะเวลาบัญชีไม่เกิน 5 ล้านบาท
                            </span>
                            <div className='flex flex-row items-center'>
                                <input id="draft1" className="mr-2" type="radio" name="status" />
                            </div>
                            <div className='flex flex-row items-center'>
                                <input id="draft1" className="mr-2" type="radio" name="status"/>
                            </div> 
                ...
                <div className='w-full col-span-3'>
                    ...
                    <div className="label grid grid-cols-5 gap-52 justify-items-start">
                        ...
                        <br></br>ที่ดิน ไม่เกิน 200 ล้านบาท และจ้างแรงงานไม่เกิน 200 คน
                        </span>
                        <div className='flex flex-row items-center'>
                ...
                <div className='w-full col-span-3'>
                    ...
                    <div className="label grid grid-cols-5 gap-52 justify-items-start">
                        ...
                        <br></br>บุคคลที่มีสินทรัพย์ถาวร ไม่รวมที่ดินไม่เกิน 200 ล้านบาทและจ้าง
                ...
                <div className='w-full col-span-3'>
                    ...
                    <div className="label grid grid-cols-5 gap-52 justify-items-start">
                        ...
                        <br></br>ที่มีรายรับไม่เกิน 1.8 ล้านบาทต่อปี หรือต่อรอบระยะเวลาบัญชี

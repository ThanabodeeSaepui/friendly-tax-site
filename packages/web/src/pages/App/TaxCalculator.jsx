  ...
  return (
    ...
    <div className="rounded-lg bg-white my-10 mx-[2%]">
      ...
      <div className='grid grid-cols-3 gap-4 items-center justify-items-center'>
        ...
        <div className='text-start'>รายได้จากการขายสินค้าและการให้บริการ</div>
          <div className='w-full max-w-xs'>
            <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
          </div>
      ...
      <div className='flex flex-row space-x-4 ml-14 mt-10'>
          ...
          <div className="dropdown dropdown-hover">
            <div className='flex flex-row items-center'>
            <h1 className='text-start text-secondary font-bold mr-4'>ค่าใช้จ่าย</h1>
              <FontAwesomeIcon icon={faPlus} size='xl' color='#740087'/>
            </div>
            {/* optional options */}
            <ul tabIndex={0} className="z-[1] dropdown-content menu p-2 bg-white rounded-box w-80 text-black">
      ...
      <div className='grid grid-cols-3 gap-4 items-center my-10 justify-items-center py-3'>
        <div className='text-start text-secondary font-bold'>รวมค่าใช้จ่าย</div>
          <div className='w-full max-w-xs'>
            <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
          </div>
          <div className='font-bold'>บาท</div>
      ...
      <div className='grid grid-cols-3 gap-4 items-center justify-items-center mt-5'>
        <div className='text-start text-secondary font-bold'>กำไรจากกิจกรรมดำเนินงาน</div>
            <div className='w-full max-w-xs'>
              <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
          </div>
          <div className='text-center'>บาท</div>
        ...
        <div className='text-start'>ส่วนแบ่งกำไร(ขาดทุน)ของบริษัทร่วมและ<br></br>การร่วมค้าตามวิธีส่วนได้เสีย</div>
        <div className='w-full max-w-xs'>
          <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
        </div>
        <div className='text-center'>บาท</div>
      ...
      {/* profit2 */}
      <div className='grid grid-cols-3 gap-4 items-center justify-items-center mt-5'>
        <div className='text-start text-secondary font-bold '>กำไรก่อนต้นทุนทางการเงิน<br></br>และค่าใช้จ่าย(รายได้) ภาษีเงินได้</div>
            <div className='w-full max-w-xs'>
              <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
          </div>
          <div className='text-center'>บาท</div>
        ...
        <div className='text-start text-secondary font-bold '>กำไรก่อนค่าใช้จ่าย(รายได้)ภาษีเงินได้</div>
        <div className='w-full max-w-xs'>
          <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
        </div>
        <div className='text-center'>บาท</div>
      ...
      <div className=' bg-[#D9D9D9]'>
      <div className='grid grid-cols-3 gap-4 items-center mt-10 justify-items-center py-3'>
        <div className='text-start text-secondary font-bold '>กำไรสำหรับปี</div>
          <div className='w-full max-w-xs'>
            <input type="text" class="input input-bordered w-full max-w-xs bg-neutral border-[#7C7C7C] focus:outline-none focus:border-secondary focus:ring-secondary" />
          </div>
          <div className='font-bold'>บาท</div>
      ...
      <div className="mx-80">
          <button className="bg-[#979797] text-white font-bold w-[45%] py-2.5 my-10 rounded-2xl" onClick={()=> window.open("/app/tax-reduction", '_parent')}>Next</button>
        </div>

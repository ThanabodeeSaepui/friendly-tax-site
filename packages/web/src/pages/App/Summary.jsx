    ...
    <>
      <div className="rounded-lg bg-white my-10 mx-[2%]">
        ...
        <div className="ml-[4%] my-10">
          ...
          <div>
            <h4>ค่าระบบและอุปกรณ์ที่สนับสนุนระบบภาษีอิเล็กทรอนิกส์</h4>
            <p>
            ...
            <ul>
              <li>
                - ร้านค้านิติบุคคลที่ใช้ระบบ POS ในการคิดค่าสินค้าและบริการ
              </li>
          ...
          <div>
            <h4>เงินบริจาค (บริจาคในนามของนิติบุคคล)</h4>

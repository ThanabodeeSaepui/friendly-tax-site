...
export default function FinancialRecordTax21() {
    return <>
    <div className="rounded-lg bg-white my-10 mx-[2%]">
        <div>
          <h2 className="text-5xl font-bold flex justify-start ml-[4%] pt-10 text-secondary">Financial Record</h2>
        ...
        <div className="flex flex-row justify-start items-center ml-[4%] my-10">
            {/* Home */}
            <div className='cursor-pointer flex flex-row' onClick={() => window.open("/app/financial-record", "_parent")}>
            ...
            {/* 2021 */}
            <div className='cursor-pointer flex flex-row ml-3' onClick={() => window.open("/app/financial-record-2021", "_parent")}>
                <FontAwesomeIcon icon={faFolder} size='lg' color='#7C7C7C'/>
                <div className='ml-1 mr-3 text-[#7C7C7C] font-medium'>2021</div>
            </div>
            ...
            <div className='ml-1 mr-3 text-secondary font-medium'>ลดหย่อนภาษี</div>
        </div>

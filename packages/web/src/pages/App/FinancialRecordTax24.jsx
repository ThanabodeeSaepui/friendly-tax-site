...
export default function FinancialRecordTax24() {
    ...
    <div className="rounded-lg bg-white my-10 mx-[2%]">
        ...
        <div className="flex flex-row justify-start items-center ml-[4%] my-10">
            ...
            {/* 2024 */}
            <div className='cursor-pointer flex flex-row ml-3' onClick={() => window.open("/app/financial-record-2024", "_parent")}>
                <FontAwesomeIcon icon={faFolder} size='lg' color='#7C7C7C'/>
                <div className='ml-1 mr-3 text-[#7C7C7C] font-medium'>2024</div>
            </div>

...
export default function FinancialRecord2023() {
    ...
    <div className="rounded-lg bg-white my-10 mx-[2%]">
        ...
        <div className="flex flex-row justify-start items-center ml-[4%] my-10">
            ...
            <div className='ml-1 mr-3 text-secondary font-medium'>2023</div>
        </div>

        <div className='grid grid-cols-3  justify-items-center space-y-10'>
            {/* row 1 */}
            <div className='mt-10'>
                <img src={FolderIcon} className='w-32 cursor-pointer' onClick={() => window.open("/app/financial-record-tax-reduction-23", "_parent")}/>

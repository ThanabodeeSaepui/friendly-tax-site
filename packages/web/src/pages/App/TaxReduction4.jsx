  ...
  return (
    <>
      <div className="rounded-lg bg-white my-10 mx-[2%]">
        ...
        {/* sub heading */}
        <div className="mr-1 text-secondary font-medium text-3xl mb-10">ค่าลดหย่อน</div> 
      ...
      <div className="grid grid-cols-3 ml-32 justify-items-center">
        ...
        <div className="flex flex-row text-start items-start justify-start col-span-2 w-full mb-10">
          ...
          <div className="flex flex-col items-start justify-center ml-5">
            <h1 className="text-secondary font-bold">ค่าซื้อกองทุนเพื่อการออม SSF</h1>
            <h1 className="text-[#7C7C7C]">
            ตามที่จ่ายจริงแต่ไม่เกิน 30% ของเงินได้ที่ต้องเสียภาษีและไม่เกิน 200,000 บาทและเมื่อรวมกับ 10. และ RMF และเบี้ยประกันชีวิตแบบบำนาญและ กอช. แล้วต้องไม่เกิน 500,000 บาท
            <br /><br />** กำไรจากการขายกองทุน SSF ที่ถือไว้จนครบเงื่อนไขจะได้รับยกเว้นภาษี      
              </h1>
          </div>
        </div>
        ...
        <div className="w-5 h-5">
          ...
          <div className="flex flex-col items-start justify-center ml-5">
            <h1 className="text-secondary font-bold">เงินบริจาคพรรคการเมือง</h1>
            <h1 className="text-[#7C7C7C]">
            ตามที่จ่ายจริงแต่ไม่เกิน 10,000 บาท
            <br /><br />**หากบริจาคด้วยทรัพย์สินหรือผลประโยชน์อื่นๆที่ไม่ใช่เงินจะต้องบริจาคสนับสนุนเฉพาะในช่วงระยะเวลาที่มีการจัดกิจกรรมระดมทุนเท่านั้น       
              </h1>
          </div>
        </div>
          <div className="text-secondary font-bold "><FontAwesomeIcon className="mr-3" icon={faArrowUpFromBracket} size="lg" color="#740087" />แนบไฟล์</div>
        ...
        <div className="flex flex-row text-start items-start justify-start col-span-2 w-full">
          ...
          <div className="flex flex-col items-start justify-center ml-5">
            ...
            <br /><br />** ต้องเป็นการซื้อสินค้าหรือบริการที่เกิดขึ้นระหว่าง 1 มกราคม - 15 กุมภาพันธ์ 2567
            <br /><br />** บุคคลต่างชาติก็ใช้สิทธิ์ลดหย่อนได้
              </h1>
          </div>
        </div>
          <div className="text-secondary font-bold "><FontAwesomeIcon className="mr-3" icon={faArrowUpFromBracket} size="lg" color="#740087" />แนบไฟล์</div>
        ...
        <div className="flex flex-row text-start items-start justify-start col-span-2 w-full my-10">
          ...
          <div className="flex flex-col items-start justify-center ml-5">
            ...
            <h1 className="text-[#7C7C7C]">
            ตามที่จ่ายจริงแต่ไม่เกิน 30% ของเงินได้ที่ต้องเสียภาษีและไม่เกิน 100,000 บาท
            <br /><br />** ต้องถือครบ 8 ปีนับจากวันที่ซื้อ
            <br /><br />** กำไรจากการขายกองทุน Thai ESG ที่ถือไว้จนครบเงื่อนไขจะได้รับยกเว้นภาษี
              </h1>
          </div>
        </div>
          <div className="text-secondary font-bold  my-10"><FontAwesomeIcon className="mr-3" icon={faArrowUpFromBracket} size="lg" color="#740087" />แนบไฟล์</div>
        ...
        <div className="flex flex-row text-start items-start justify-start col-span-2 w-full">
          ...
          <div className="flex flex-col items-start justify-center ml-5">
            ...
            <h1 className="text-[#7C7C7C]">
            สองเท่าของเงินบริจาคตามที่จ่ายจริงแต่ไม่เกิน 10% ของเงินได้หลังหักค่าลดหย่อนตั้งแต่ข้อ 1 ถึงข้อ 18
            <br /><br />** หย่อนได้ 2 เท่าของที่บริจาคจริง
            <br /><br />** ต้องเป็นการบริจาค ผ่านระบบ e-Donation เท่านั้น
              </h1>
          </div>
        </div>
          <div className="text-secondary font-bold  "><FontAwesomeIcon className="mr-3" icon={faArrowUpFromBracket} size="lg" color="#740087" />แนบไฟล์</div>
          ...
          <div className="flex flex-col items-start justify-center ml-5">
            ...
            <h1 className="text-[#7C7C7C]">
            ตามที่จ่ายจริงแต่ไม่เกิน 10% ของเงินได้หลังหักค่าลดหย่อนตั้งแต่ข้อ 1 ถึงข้อ 19
            <br /><br />** ใบอนุโมทนาบุญหรือใบเสร็จรับเงินต้องระบุชื่อคุณเป็นผู้บริจาคใช้เป็นหลักฐานการยืนยันสิทธิ์
            <br /><br />** กรณีบริจาคผ่านระบบอิเล็กทรอนิกส์จะไม่ต้องใช้หลักฐานการบริจาค
              </h1>
          </div>
        </div>
        <div className="text-secondary font-bold my-10"><FontAwesomeIcon className="mr-3" icon={faArrowUpFromBracket} size="lg" color="#740087" />แนบไฟล์</div>
